...
declare function local:update-refs(){
    for $ref in $local:tei//tei:ref[not(@type)][starts-with(lower-case(@cRef), 'f.')]
    return
        update insert attribute type { 'folio' } into $ref
};

declare function local:update-tei-locations(){
