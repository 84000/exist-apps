...
<xsl:stylesheet xmlns="http://www.daisy.org/z3986/2005/ncx/" xmlns:m="http://read.84000.co/ns/1.0" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:epub="http://www.idpf.org/2007/ops" xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="#all" version="3.0">
        ...
        <ncx version="2005-1" xml:lang="en">
            ...
            <navMap>
                ...
                <xsl:call-template name="toc-parts">
                    <xsl:with-param name="parts" select="m:translation/m:part[not(@type eq 'citation-index')]"/>
