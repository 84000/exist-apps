        ...
        <div>
            <ul class="list-inline inline-dashes">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:when test="$section-webflow-api-item">
                            <span class="label label-default">
                                <xsl:value-of select="concat('Webflow CMS last updated ', (format-dateTime($section-webflow-api-item/@updated, '[D01] [MNn,*-3] [Y] [H01]:[m01]:[s01]'), '[unknown]')[1])"/>
                            </span>
                        </xsl:when>
                        <xsl:otherwise>
                ...
                <xsl:if test="$section-webflow-api-item[@updated ! xs:dateTime(.) lt $section/@last-updated ! xs:dateTime(.)]">
                    <li>
                        <span class="label label-warning">
                            <xsl:value-of select="concat('Content updated ', (format-dateTime($section/@last-updated, '[D01] [MNn,*-3] [Y] [H01]:[m01]:[s01]'), '[unknown]')[1])"/>
                        </span>
                    </li>
                </xsl:if>
            </ul>
                        ...
                        <td>
                            ...
                            <div class="center-vertical align-left">
                                ...
                                <xsl:if test="$text-webflow-api-item[@updated ! xs:dateTime(.) lt $text/@last-updated ! xs:dateTime(.)]">
                                    <span>
                                        <span class="label label-warning">
                                            <xsl:value-of select="concat('Content updated ', (format-dateTime($text/@last-updated, '[D01] [MNn,*-3] [Y] [H01]:[m01]:[s01]'), '[unknown]')[1])"/>
                                        </span>
                                    </span>
                                </xsl:if>
                            </div>
