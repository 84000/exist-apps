...
<xsl:stylesheet xmlns="http://schemas.openxmlformats.org/package/2006/content-types" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:m="http://read.84000.co/ns/1.0" version="2.0">
    ...
    <xsl:template name="generate_manifest">
        ...
        <!-- Standard manifest -->
        <m:entry href="[Content_Types].xml">
            <Types>
                <xsl:if test="$media">
                ...
                <xsl:call-template name="man_workbook">
                ...
                <xsl:call-template name="man_drawing_generator">
                    <xsl:with-param name="drawings" select="$drawings"/>
                </xsl:call-template>
                <xsl:if test="$vbas">
        ...
        <m:entry href="xl/_rels/workbook.xml.rels">
            <Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
    ...
    <!-- The rels generator -->
    <xsl:template xmlns="http://schemas.openxmlformats.org/package/2006/relationships" name="man_wkrels_generator">
        <xsl:param name="sheets"/>
