                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="sml-margin bottom">
                                                ...
                                                <ul class="list-inline">
                                                    ...
                                                    <li class="small">
                                                        ...
                                                        <xsl:choose>
                                                            <xsl:when test="$text-tei-version gt ''">
                                                                <xsl:value-of select="concat('Local TEI: ', $text-tei-version)"/>
                                                            </xsl:when>
                                                            <xsl:otherwise>
                                                                <xsl:attribute name="class" select="'small text-muted'"/>
                                                                <xsl:value-of select="'Local TEI: [No version]'"/>
                                                            </xsl:otherwise>
                                                        </xsl:choose>
                                                    </li>
                                                    ...
                                                    <xsl:if test="$environment/m:store-conf[@type eq 'client']">
                                                        <li class="small">
                                                            ...
                                                            <xsl:value-of select="concat('Master TEI: ', $text-master-tei-version)"/>
                                                        </li>
                                                    </xsl:if>
                                            ...
                                            <div class="row">
                                                ...
                                                <xsl:variable name="file-formats" select="('pdf', 'epub', 'rdf', 'cache', 'json')"/>
