                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-content">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a target="test-layout">
                                        <xsl:attribute name="href" select="concat($reading-room-path, '/translation/UT22084-081-006.html#abbreviations')"/> Abbreviations with header &amp; footer </a>
                                </li>
                                <li>
                                    <a target="test-layout">
