                ...
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3">
                        ...
                        <ul>
                            ...
                            <li>
                                <a target="test-layout">
                                    <xsl:attribute name="href" select="concat($reading-room-path, '/translation/UT22084-001-001.html#UT22084-001-001-781')"/>
                            ...
                            <li>
                                <a target="test-layout">
                                    <xsl:attribute name="href" select="concat($reading-room-path, '/translation/UT22084-079-011.html#UT22084-079-011-prologue')"/>
                            ...
                            <li>
                                ...
                                <a target="test-layout">
                                    <xsl:attribute name="href" select="concat($reading-room-path, '/translation/UT22084-031-002.html#UT22084-031-002-chapter-1')"/>
                                    <xsl:value-of select="'with numbers and titles'"/>
                                </a>
                                <xsl:value-of select="', '"/>
                                <a target="test-layout">
                                    <xsl:attribute name="href" select="concat($reading-room-path, '/translation/UT22084-056-002.html#UT22084-056-002-chapter-1')"/>
                                    <xsl:value-of select="'without titles'"/>
                                </a>
                                <xsl:value-of select="', '"/>
                                <a target="test-layout">
                                    <xsl:attribute name="href" select="concat($reading-room-path, '/translation/UT22084-046-001.html#UT22084-046-001-colophon')"/>
                                    <xsl:value-of select="'Colophon chapters'"/>
                                </a>
                                <xsl:value-of select="', '"/>
                                <a target="test-layout">
                                    <xsl:attribute name="href" select="concat($reading-room-path, '/translation/UT22084-080-015.html#UT22084-080-015-appendix')"/>
                            ...
                            <li>
                                ...
                                <a target="test-layout">
                                    <xsl:attribute name="href" select="concat($reading-room-path, '/translation/UT22084-040-003.html#UT22084-040-003-colophon')"/>
                            ...
                            <li>
                                ...
                                <a target="test-tables-layout-2">
                                    <xsl:attribute name="href" select="concat($reading-room-path, '/translation/toh361.html?view-mode=ebook#UT22084-077-002-623')"/>
